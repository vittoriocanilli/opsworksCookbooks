...
file_location = File.join(node['nginx']['dir'], "sites-available", "samplecompany_gameboard")
template file_location do
  ...
  variables(
    ...
    :server_name => node['samplecompany-gameboard']['server_name']
   )
end

# Enable the site
nginx_site "samplecompany_gameboard" do
  enable  true
end
